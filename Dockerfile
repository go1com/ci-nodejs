...
RUN apt-get update -qq \
    && apt-get install curl ca-certificates apt-utils -y --no-install-recommends -qq \
    ...
    && apt-get update -qq \
    && apt-get install -y -qq --no-install-recommends ruby-dev make nodejs python g++ build-essential python-software-properties git-core libnss3 libfontconfig gettext default-jre google-chrome-stable firefox \
    && apt-get clean \
